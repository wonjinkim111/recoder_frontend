...
class MenteeList extends React.Component{
    ...
    componentDidMount(){
        ...
        //console.log(getUrl);
        //console.log(roomId);
       //const url = `http://192.168.45.7145.20745.207:10000/users/mentor/mentees/19`;
       //console.log(this.props.match.params);
       const url = `http://192.168.45.7145.207:10000/users/mentor/mentees/${this.props.match.params.id}`;
        axios.get(url)
            .then(response=>{
